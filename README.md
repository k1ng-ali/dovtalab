...
- 🎯 **Контексты вопросов** — прохождение квиза в рамках выбранной темы
...
### Главная (`/`)
Фоновый блок с приветствием, виджет лидерборда (топ-3 + позиция текущего пользователя), виджет статистики с историей последних попыток.
...
- **info** — мета-информация, прогресс, выбор контекста
